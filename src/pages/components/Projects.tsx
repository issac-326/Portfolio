...
export default function Projects() {
    ...
    const language = lang ? getValidLanguage(lang) : 'en'; // Usa la función de validación

    const t = useTranslations(language); // TypeScript ahora debería reconocer el tipo
    ...
    return (
        <div className="grid grid-cols-3 gap-5">
            ...
            <Card className="overflow-hidden black-card dark:black-card">
                    <Carousel
                        opts={{
                            loop: true
                        }}
